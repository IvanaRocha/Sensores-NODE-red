...
# Configuración del pin del sensor KY-020 Ball Switch (conectado al pin digital D4)
pin_ball_switch = Pin(18, Pin.IN)
...
def read_ball_switch_sensor():
    return pin_ball_switch.value()
...
def main():
    ...
    while True:
        inclination_detected = read_ball_switch_sensor()
        if inclination_detected:
