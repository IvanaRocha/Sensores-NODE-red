...
# Configuración del pin del sensor KY-003 Hall Magnetic (conectado al pin digital D4)
pin_hall = Pin(16, Pin.IN)
...
def main():
    ...
    while True:
        magnetic_detected = read_hall_sensor()
