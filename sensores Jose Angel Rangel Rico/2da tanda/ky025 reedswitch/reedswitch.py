...
# Configuración del pin del sensor KY-025 Reed Switch (conectado al pin digital D4)
pin_reed_switch = Pin(4, Pin.IN)
...
def read_reed_switch_sensor():
    return pin_reed_switch.value()
...
def main():
    ...
    while True:
        switch_state = read_reed_switch_sensor()
        if switch_state:
